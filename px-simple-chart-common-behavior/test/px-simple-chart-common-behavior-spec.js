...
describe('Instancing component from provided DOM data attribute', function () {
    ...
    before(function() {
        ...
        return driver.wait(webdriver.until.elementLocated(webdriver.By.css("px-simple-chart-common-behavior .circle")), 3000);
    });

    it('should instance a px-app-nav from the expected DOM', function () {
        return chai.expect(
            driver.findElement(webdriver.By.css("px-simple-chart-common-behavior"))
        ).to.eventually.exist;
    });
});
